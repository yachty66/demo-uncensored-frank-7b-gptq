...
# Banana.dev Uncensored-Frank-7B-GPTQ starter template

This is a Uncensored-Frank-7B-GPTQ starter template from [Banana.dev](https://www.banana.dev) that allows on-demand serverless GPU inference.
...
1. [Fork this](https://github.com/yachty66/demo-uncensored-frank-7b-gptq/fork) repository to your own Github account.
